...
function DungeonCreator.MainWindow()
    if self.GUI.Open then
        ...
        GUI:Begin("DungeonCreator", self.GUI.Open, flags)
...
-- ------------------------- Save Profile ------------------------
                        ...
                        if GUI:IsItemClicked(SaveProfile) then 
                            ...
                            if FileExists(FilePath) then
                                FileSave(FilePath, DungeonCreator.CurrentFile)
                            end
                        end
...
-- ------------------------- Settings ------------------------
                            ...
                            MashLib.UI.BeginTitledChild([[ProfileSettings]], [[Settings]], 715, 185, 0)
                                GUI:Indent()
                                    GUI:Columns(2, [[]], false)
                                    GUI:SetColumnWidth(-1, 200)
                                    ...
                                    GUI:NextColumn()
                                        GUI:Text([[Hacks]])
                                    GUI:NextColumn()
                                        DungeonCreator.CurrentFile.hacks = GUI:Checkbox([[Enabled##HacksEnabled]], DungeonCreator.CurrentFile.hacks)
                                    GUI:Columns(1)
                                GUI:Unindent()
                            MashLib.UI.PopTitledChild()
